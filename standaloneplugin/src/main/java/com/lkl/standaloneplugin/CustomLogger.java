...
public class CustomLogger {
    ...
    public static void setConfig(CustomExtension extension) {
        sEnableDebug = extension.isEnableDebug();
        sEnableLog = extension.isEnableLog() || extension.isEnableDebug();
        sAbortOnError = extension.isAbortOnError();
    }
